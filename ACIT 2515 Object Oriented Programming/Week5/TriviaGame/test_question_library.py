...
def test_library_init():
    with patch("builtins.open", new_callable=mock_open, read_data=JSON_FILE) as mock_file:
        lib = QuestionLibrary("THAT_FILE_DOES_NOT_EXIST_BUT_ITS_OK_BECAUSE_I_USED_PATCH.whynot")
        assert mock_file.call_count == 1
        mock_file.assert_called_once_with("THAT_FILE_DOES_NOT_EXIST_BUT_ITS_OK_BECAUSE_I_USED_PATCH.whynot", "r")
